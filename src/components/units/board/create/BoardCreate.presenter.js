...
const BoardCreateUI = (props) => {
    ...
    return (
        <S.Contain>
            <S.ContainBox>
                <S.Hown>게시물 등록</S.Hown>
                <S.UserBox>
                    <S.IdFlexStyledBox>
                        <S.UserInformationLabel htmlFor="user">작성자</S.UserInformationLabel>
                        <S.UserInformationInput name='user' value={user} type="text" id="user" placeholder='이름을 적어주세요' onChange={boardStateChangeHandler} />
                    ...
                    <S.PasswordFlexStyledBox>
                        ...
                        <S.UserInformationInput name='password' value={password} type="password" id="password" placeholder='비밀번호를 적어주세요' onChange={boardStateChangeHandler} />
                        <S.ErrorMessage>{passwordError}</S.ErrorMessage>
                    </S.PasswordFlexStyledBox>
                </S.UserBox>
                <S.TitleBox>
                    <S.TitleLabel htmlFor="title">제목</S.TitleLabel>
                    <S.TitleInput name='title' value={title} type="text" id="title" placeholder='제목을 작성해주세요' onChange={boardStateChangeHandler} />
                    <S.ErrorMessage>{titleError}</S.ErrorMessage>
                </S.TitleBox>
                <S.ContentBox>
                    <S.ContentLabel htmlFor="content">내용</S.ContentLabel>
                    <S.ContentInput name='content' value={content} type="text" id="content" placeholder='내용을 작성해주세요' onChange={boardStateChangeHandler} />
                ...
                <S.ConfirmBox>
                    ...
                    <S.EmendButton onClick={onClickSubmit}>등록하기</S.EmendButton>
                </S.ConfirmBox>
            </S.ContainBox>
        </S.Contain>
    )
